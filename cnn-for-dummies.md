...
\\[p   = \\qquad i^{l+1} + (H^l - H + 1) \\times j^{l+1},   \\qquad (16)\\]
\\[q   = \\qquad i + H \\times j + H \\times W \\times d^l, \\qquad (17)\\]
\\[i^l = \\qquad \\qquad \\qquad \\qquad i^{l+1} + i,               \\qquad (18)\\]
\\[j^l = \\qquad \\qquad \\qquad \\qquad j^{l+1} + j .              \\qquad (19)\\]
